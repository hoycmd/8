...
blueTeam.Build.BlocksSet.Value = BuildBlocksSet.СИНИЕ;
redTeam.Build.BlocksSet.Value = BuildBlocksSet.КРАСНЫЕ;
...
Damage.OnKill.Add(function(player, killed) {
	if (killed.Team != null && killed.Team != player.Team) {
		...
		player.Properties.Scores.Value += 100000000000000000000000000;
	}
});
